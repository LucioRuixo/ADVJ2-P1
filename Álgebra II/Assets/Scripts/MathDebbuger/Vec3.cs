...
namespace CustomMath
{
    public struct Vec3 : IEquatable<Vec3>
    {
        ...
        {
            return Mathf.Acos((Dot(from, to) / (Magnitude(from) * Magnitude(to))) * Mathf.Deg2Rad);
        }
        ...
        {
            return Mathf.Abs(Magnitude(a - b));
        }
        ...
        public static void Scale(ref Vec3 a, Vec3 b)
        {
            a.x *= b.x;
            a.y *= b.y;
            a.z *= b.z;
        ...
        public static void Normalize(ref Vec3 value)
        {
